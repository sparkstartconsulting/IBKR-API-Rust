    ...
    T: Wrapper + Sync,
{
    ...
    fn process_historical_news(&mut self, fields: &[String]) -> Result<(), IBKRApiLibError> {
        ...
        self.wrapper.lock().unwrap().deref_mut().historical_news(
            req_id,
            time.as_ref(),
    ...
    fn process_news_article(&mut self, fields: &[String]) -> Result<(), IBKRApiLibError> {
        ...
        self.wrapper.lock().unwrap().deref_mut().news_article(
            req_id,
            article_type,
            article_text.as_ref(),
        );
    ...
    fn process_pnl(&mut self, fields: &[String]) -> Result<(), IBKRApiLibError> {
        ...
        self.wrapper.lock().unwrap().deref_mut().pnl(
            req_id,
            daily_pnl,
            unrealized_pnl,
            realized_pnl,
    ...
    fn process_pnl_single(&mut self, fields: &[String]) -> Result<(), IBKRApiLibError> {
        ...
        self.wrapper.lock().unwrap().deref_mut().pnl_single(
            req_id,
            pos,
            daily_pnl,
            unrealized_pnl,
    ...
    fn process_portfolio_value(&mut self, fields: &[String]) -> Result<(), IBKRApiLibError> {
        ...
        self.wrapper.lock().unwrap().deref_mut().update_portfolio(
            contract,
            position,
            market_price,
            market_value,
    ...
    fn process_position_data(&mut self, fields: &[String]) -> Result<(), IBKRApiLibError> {
        ...
        self.wrapper.lock().unwrap().deref_mut().position(
            account.as_ref(),
            contract,
            position,
            avg_cost,
    ...
    fn process_position_multi(&mut self, fields: &[String]) -> Result<(), IBKRApiLibError> {
        ...
        self.wrapper.lock().unwrap().deref_mut().position_multi(
            req_id,
            account.as_ref(),
            model_code.as_ref(),
            contract,
    ...
    fn process_scanner_data(&mut self, fields: &[String]) -> Result<(), IBKRApiLibError> {
        ...
        for _ in 0..number_of_elements {
            ...
            self.wrapper.lock().unwrap().deref_mut().scanner_data(
                req_id,
                data.rank,
                data.contract,
    ...
    fn process_tick_efp(&mut self, fields: &[String]) -> Result<(), IBKRApiLibError> {
        ...
        self.wrapper.lock().unwrap().deref_mut().tick_efp(
            ticker_id,
            FromPrimitive::from_i32(tick_type).unwrap(),
            basis_points,
    ...
    fn process_tick_generic(&mut self, fields: &[String]) -> Result<(), IBKRApiLibError> {
        ...
        self.wrapper.lock().unwrap().deref_mut().tick_generic(
            ticker_id,
            FromPrimitive::from_i32(tick_type).unwrap(),
            value,
        );
    ...
    fn process_tick_news(&mut self, fields: &[String]) -> Result<(), IBKRApiLibError> {
        ...
        self.wrapper.lock().unwrap().deref_mut().tick_news(
            ticker_id,
            time_stamp,
            provider_code.as_ref(),
            article_id.as_ref(),
    ...
    fn process_tick_req_params(&mut self, fields: &[String]) -> Result<(), IBKRApiLibError> {
        ...
        self.wrapper.lock().unwrap().deref_mut().tick_req_params(
            ticker_id,
            min_tick,
            bbo_exchange.as_ref(),
    ...
    fn process_tick_size(&mut self, fields: &[String]) -> Result<(), IBKRApiLibError> {
        ...
        self.wrapper.lock().unwrap().deref_mut().tick_size(
            ticker_id,
            FromPrimitive::from_i32(tick_type).unwrap(),
            size,
        );
